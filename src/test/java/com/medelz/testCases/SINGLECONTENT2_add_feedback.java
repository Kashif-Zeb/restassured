...
public class SINGLECONTENT2_add_feedback extends TestBase{
	...
	requestParams.put("feedback_text", "checking the feedback");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/add_feedback");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("checking the feedback"), true);
		Assert.assertEquals(responseBody.contains("Feedback has been added."), true);
...
void tearDown()
{
	logger.info("*********  Finished add_feedback **********");
}
