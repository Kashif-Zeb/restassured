...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/delete_from_album");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Content has been deleted from the album."), true);
...
void tearDown()
{
	logger.info("*********  Finished delete_from_album **********");
}
