...
public class FORGOTTENPASSWORD_update_password extends TestBase{
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/users/update-password");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Your password has been updated."), true);
...
void tearDown()
{
	logger.info("*********  Finished update_password **********");
}
