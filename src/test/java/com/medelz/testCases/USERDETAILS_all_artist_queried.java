...
public class USERDETAILS_all_artist_queried extends TestBase{
	...
	requestParams.put("user_country", "PK");
	requestParams.put("hire_me", "");
	requestParams.put("collab", "");
	requestParams.put("user_skill", "");
	requestParams.put("user_language", "");
	requestParams.put("user_city", "");
	requestParams.put("user_state", "");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/all_artists_queried");
...
void tearDown()
{
	logger.info("*********  Finished all_artist_queried **********");
}
