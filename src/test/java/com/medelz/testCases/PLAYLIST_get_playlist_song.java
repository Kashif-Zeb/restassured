...
public class PLAYLIST_get_playlist_song extends TestBase{
	...
	String playid = readFromFile("playlistid.txt");
	...
	requestParams.put("page",1); // Cast
	requestParams.put("perPage",10);
//	requestParams.put("playlistid",9067);
	requestParams.put("playlistid",id);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/get_public_playlists");
...
void tearDown()
{
	logger.info("*********  Finished get_playlist_song **********");
}
