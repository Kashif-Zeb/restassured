...
public class SINGLECONTENT2_favourite_list extends TestBase{
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/favourite_list");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Favourite posts are listed below."), true);
...
void tearDown()
{
	logger.info("*********  Finished favourite_list **********");
}
