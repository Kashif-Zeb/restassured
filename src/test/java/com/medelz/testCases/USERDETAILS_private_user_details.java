...
public class USERDETAILS_private_user_details extends TestBase{
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.GET,"/v1/get_user_details");
...
//		Assert.assertEquals(responseBody.contains("kashif"), true);
	...
	void tearDown()
	{
		logger.info("*********  Finished private_user_details **********");
	}
