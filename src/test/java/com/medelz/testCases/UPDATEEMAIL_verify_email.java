...
public class UPDATEEMAIL_verify_email extends TestBase{
	...
	{
		Thread.sleep(10000);
	logger.info("*********Started verify_email **********");
	...
	System.out.print("Enter a value:otp ");
	int potp = scanner.nextInt();
	System.out.print(potp);

	requestParams.put("updated_email",emaill);
	requestParams.put("otp",potp);// Cast
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/verify_updated_email");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Your email has been updated!"), true);
...
void tearDown()
{
	logger.info("*********  Finished verify_email **********");
}
