...
public class ALBUM_delete_album extends TestBase{
	...
	@BeforeClass
	void delete_album() throws InterruptedException
	{
	
	logger.info("*********Started delete_album **********");
		
	RestAssured.baseURI = TestBase.baseURI;
	httpRequest = RestAssured.given();
	JSONObject requestParams = new JSONObject();
	requestParams.put("type", "music"); // Cast
//	requestParams.put("id",9060);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/delete_album");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Album has been deleted!"), true);
...
void tearDown()
{
	logger.info("*********  Finished delete_album **********");
}
