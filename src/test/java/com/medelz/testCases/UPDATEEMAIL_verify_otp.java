...
public class UPDATEEMAIL_verify_otp extends TestBase{
	...
	requestParams.put("old_email",emaill);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/verify_otp");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("OTP is verified."), true);
...
void tearDown()
{
	logger.info("*********  Finished verify_otp **********");
}
