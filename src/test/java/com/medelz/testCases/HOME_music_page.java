...
public class HOME_music_page extends TestBase{

	String gettoken = readFromFile("token.txt");
	@BeforeClass
	void musicpage() throws InterruptedException
	{
		Thread.sleep(10000);
	logger.info("*********Started music_page **********");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.GET,"/v1/music_page_api_copy");
...
void tearDown()
{
	logger.info("*********  Finished music_page **********");
}
