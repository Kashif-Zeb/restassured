...
public class USERDETAILS_change_entity_image extends TestBase{
	...
	requestParams.put("entity_aws_key", "wp-content/uploads/Music-Art3.jpg"); // Cast
	requestParams.put("banner_attachment_id",23433 );
	requestParams.put("image_height", 22);
	requestParams.put("image_width", 22);
	requestParams.put("file_size", 26843);
	requestParams.put("content_type", "content_banner");
	requestParams.put("entity_id",4948);
	requestParams.put("content_category", "music");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/change_entity_image");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("content banner image has been updated."), true);
...
void tearDown()
{
	logger.info("*********  Finished change_entity_image **********");
}
