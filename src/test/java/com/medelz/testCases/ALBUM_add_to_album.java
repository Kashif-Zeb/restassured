...
//	requestParams.put("album_id",9060);
	requestParams.put("album_id",alid);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/add_to_album");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Content has been added in album."), true);
...
void tearDown()
{
	logger.info("*********  Finished add_to_album **********");
}
