...
public class SINGLECONTENT2_add_comment extends TestBase{
	...
	requestParams.put("comment_data", "I am adding a test comment");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/add_comment");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Comment has been added."), true);
		Assert.assertEquals(responseBody.contains("I am adding a test comment"), true);
...
void tearDown()
{
	logger.info("*********  Finished add_comment **********");
	commentid();
}
