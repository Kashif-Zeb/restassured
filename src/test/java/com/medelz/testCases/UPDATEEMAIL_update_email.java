...
public class UPDATEEMAIL_update_email extends TestBase{
	...
	requestParams.put("new_email",emaill);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/update_user_email");
...
void tearDown()
{
	logger.info("*********  Finished update_email **********");
}
