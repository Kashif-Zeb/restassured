...
public class SINGLECONTENT2_content_suggestions extends TestBase{
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/single_post_suggestions");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Success! Your song suggestions have been found."), true);
...
void tearDown()
{
	logger.info("*********  Finished content_suggestions **********");
}
