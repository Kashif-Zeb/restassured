...
public class FORGOTTENPASSWORD_password_reset_email extends TestBase{
	...
	requestParams.put("email",emaill); // Cast
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/users/get_password_reset_email");
...
void tearDown()
{
	logger.info("*********  Finished password_reset_email **********");
}
