...
public class USERDETAILS_list_of_followed_users extends TestBase{
	...
	requestParams.put("follow_entity", "followers"); // Cast
	requestParams.put("user_id",aid );
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..MFCY0XAogSXQOO_Bid6Rd-RSC9nXGgkLfAwPgYffTd4");
	...
	response = httpRequest.request(Method.POST,"/v1/user_followings");
...
void tearDown()
{
	logger.info("*********  Finished list_of_followed_users **********");
}
