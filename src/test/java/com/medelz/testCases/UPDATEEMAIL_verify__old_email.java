...
public class UPDATEEMAIL_verify__old_email extends TestBase{
	...
	@BeforeClass
	void verify__old_email() throws InterruptedException
	{
		Thread.sleep(10000);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/verify_user_email");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Mail is successfully sent. Please check your inbox."), true);
...
void tearDown()
{
	logger.info("*********  Finished verify__old_email **********");
}
