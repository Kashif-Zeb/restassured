...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/users/reset-password-otp-verification");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("OTP is confirmed."), true);
...
void tearDown()
{
	logger.info("*********  Finished otp_confirmation_request **********");
}
