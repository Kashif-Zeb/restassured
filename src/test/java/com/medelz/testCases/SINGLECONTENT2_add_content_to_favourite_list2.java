...
public class SINGLECONTENT2_add_content_to_favourite_list2 extends TestBase{
	...
	requestParams.put("favourite_status",0);
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/add_favouriteList");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("0"), true);
		Assert.assertEquals(responseBody.contains("Cloud flare test \\u2013 new' has been removed from your favourite list."), true);
...
void tearDown()
{
	logger.info("*********  Finished add_content_to_favourite_list **********");
}
