...
public class SINGLECONTENT2_get_comment extends TestBase{

	
	@BeforeClass
	void get_comment() throws InterruptedException
	{
		Thread.sleep(10000);
	logger.info("*********Started get_comment **********");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/get_post_comments");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("Comments are listed!."), true);
...
void tearDown()
{
	logger.info("*********  Finished get_comment **********");
}
