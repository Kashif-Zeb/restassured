...
public class LOCATIONS_get_countries extends TestBase{
	...
	requestParams.put("entity","countries"); // Cast
	requestParams.put("country_iso","PK");
	requestParams.put("state_id",3176);
	requestParams.put("entity_q","");
...
//	httpRequest.header("Authorization-Token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..enoZJx5z9BrfzFTuzwFXOAb-i1KMVYHlSroV5nybMEE");
	...
	response = httpRequest.request(Method.POST,"/v1/get_user_country");
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains("countries are found!"), true);
...
void tearDown()
{
	logger.info("*********  Finished get_countries **********");
}
